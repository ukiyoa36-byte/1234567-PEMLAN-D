...
public class Jaket {
    ...
    public static final int JAKET_A = 100_000;
    public static final int JAKET_B = 125_000;
    public static final int JAKET_C = 175_000;
    ...
    public static  int hitungTotal(int jumlahA, int jumlahB, int jumlahC) {
       if (jumlahA > 100) {
        ...
        System.out.println("harga jaket A = " + jumlahA);
        System.out.println("harga jaket B = " + jumlahB);
        System.out.println("harga jaket C = " + jumlahC);
